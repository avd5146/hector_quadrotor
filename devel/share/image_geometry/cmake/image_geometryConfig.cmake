...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/ankur/hector_quadrotor_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/ankur/hector_quadrotor_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/ankur/hector_quadrotor_ws/install)
...
if(NOT "/home/ankur/hector_quadrotor_ws/src/vision_opencv/image_geometry/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ankur/hector_quadrotor_ws/src/vision_opencv/image_geometry/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ankur/hector_quadrotor_ws/src/vision_opencv/image_geometry/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
