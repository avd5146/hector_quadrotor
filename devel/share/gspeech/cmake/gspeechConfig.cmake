...
if("TRUE" STREQUAL "TRUE")
  set(gspeech_SOURCE_PREFIX /home/ankur/hector_quadrotor_ws/src/gspeech)
  set(gspeech_DEVEL_PREFIX /home/ankur/hector_quadrotor_ws/devel)
  set(gspeech_INSTALL_PREFIX "")
  set(gspeech_PREFIX ${gspeech_DEVEL_PREFIX})
else()
  set(gspeech_SOURCE_PREFIX "")
  set(gspeech_DEVEL_PREFIX "")
  set(gspeech_INSTALL_PREFIX /home/ankur/hector_quadrotor_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gspeech' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'achuwilsonGEC Sreekrishnapuram+91-9400418468 <achu@achuwilson.in>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gspeech' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ankur/hector_quadrotor_ws/src/gspeech/${idir}'.  Ask the maintainer 'achuwilsonGEC Sreekrishnapuram+91-9400418468 <achu@achuwilson.in>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gspeech_dep}_FOUND)
      find_package(${gspeech_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gspeech_dep} REQUIRED ${depend_list})
  endif()
